...
export default function Loginform() {
    return (
        <>
            <div class="flex justify-center items-center bg-gray-100 font-[sans-serif] h-full md:min-h-screen p-4 mt-4">
                    ...
                    <form class="bg-white rounded-2xl p-6  shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
                        ...
                        <div class="mt-6">
                            <div class="relative flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] right-2 cursor-pointer" viewBox="0 0 128 128">
